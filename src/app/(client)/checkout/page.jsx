      ...
      const res = await fetch("/api/orders", {
        ...
        body: JSON.stringify({
          ...
          products: cart.map((item) => ({
            ...
            basePrice: item.newPrice, // or item.basePrice if you have both
            finalPrice: item.newPrice * item.quantity, // total for that item
            selectedVariants: item.selectedVariants || [], // pass selected variants
          })),
          totalPrice: total,
